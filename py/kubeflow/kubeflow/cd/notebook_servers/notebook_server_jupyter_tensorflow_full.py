...
def create_workflow(name=None, namespace=None, bucket=None, **kwargs):
    ...
    return builder.build(dockerfile="components/example-notebook-servers/jupyter-tensorflow-full/Dockerfile.CPU",
                         ...
                         second_dockerfile="components/example-notebook-servers/jupyter-tensorflow-full/Dockerfile.CUDA",
